...
func (x *GetByIdsRes_UserProfile) GetGroupId() int64 {
	if x != nil {
		return x.GroupId
	}
	return 0
...
const file_user_v1_profile_profile_proto_rawDesc = "" +
	...
	"\auserIds\x18\x01 \x03(\x03R\auserIds\"\xda\x01\n" +
	"\vGetByIdsRes\x12@\n" +
	"\bprofiles\x18\x01 \x03(\v2$.api.user.v1.GetByIdsRes.UserProfileR\bprofiles\x1a\x88\x01\n" +
	"\vUserProfile\x12\x16\n" +
	"\x06userId\x18\x01 \x01(\x03R\x06userId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x16\n" +
	"\x06avatar\x18\x03 \x01(\tR\x06avatar\x12\x19\n" +
	"\bgroup_id\x18\x04 \x01(\x03R\agroupId\x12\x1a\n" +
	"\busername\x18\x05 \x01(\tR\busername2\xe8\x06\n" +
	"\aProfile\x12_\n" +
